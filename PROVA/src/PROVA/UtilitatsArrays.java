...
public class UtilitatsArrays {
    ...
    public static int SumaArray(int longitud) {
        int contador = 0;
    ...
    public static double Mitjana(int[] array) {
        ...
        return (double)contador/array.length;
    }
    ...
    public static int MostraMinim(int[] array) {
        int minim = array[0];
        for (int valor : array) {
            if (minim > valor) {
                minim = valor;
    ...
    public static int MostraMaxim(int[] array) {
        int maxim = array[0];
        for (int valor : array) {
            if (maxim < valor) {
            maxim = valor;
